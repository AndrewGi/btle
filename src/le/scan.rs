...
impl ScanInterval {
    pub const MIN: ScanInterval = ScanInterval(INTERVAL_MIN);
    pub const MAX: ScanInterval = ScanInterval(INTERVAL_MAX);
...
impl ScanWindow {
    pub const MIN: ScanWindow = ScanWindow(INTERVAL_MIN);
    pub const MAX: ScanWindow = ScanWindow(INTERVAL_MAX);
    pub const BYTE_LEN: usize = 2;
